...
class Promotion
{
    ...
    #[ORM\OneToMany(mappedBy: 'Promotion', targetEntity: Etudiant::class, orphanRemoval: true)]
    private $etudiants;

    #[ORM\ManyToMany(targetEntity: Module::class, mappedBy: 'Promotion')]
    private $modules;
